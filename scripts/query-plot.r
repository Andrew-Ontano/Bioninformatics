...
spectraPlot = function(values, legend=FALSE, facet=FALSE, frequencies=FALSE, ylims=TRUE){
...
for(seq in seq.names){
	...
	p = spectraPlot(temp.values, legend=opt$legend, facet=faceted, frequencies=opt$frequencies, ylims=opt$ylims)
